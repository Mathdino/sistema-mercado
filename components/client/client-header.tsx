      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            {user ? (
              <>
                <p className="text-xs text-muted-foreground">Olá, {formatUserName(user?.name)}</p>
                {defaultAddress && (
              ...
              <>
                ...
                <p className="text-sm font-medium">faça seu login e aproveite nossas ofertas de casa</p>
              </>
            )}
          </div>
        </div>
