              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Crie novas categorias de produtos
                  </p>
                </div>
                          ...
                          <div className="flex justify-between items-start gap-2">
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                >
                                  {updatingProductIds.has(product.id) && (
                                ...
                                {product.featured ? (
                                  <DropdownMenuItem
                                    onClick={() =>
                                      handleToggleFeatured(product.id, false)
                                    }
                                    disabled={updatingProductIds.has(
                                      product.id
                                    )}
                                  >
                                    {updatingProductIds.has(product.id) && (
                                  ...
                                  <DropdownMenuItem
                                    onClick={() =>
                                      handleToggleFeatured(product.id, true)
                                    }
                                    disabled={updatingProductIds.has(
                                      product.id
                                    )}
