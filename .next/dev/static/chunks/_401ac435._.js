...
function ClientHeader({ showBack = false }) {
    ...
    const itemCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])({
        "ClientHeader.useCartStore[itemCount]": (state)=>state.getItemCount()
    }["ClientHeader.useCartStore[itemCount]"]);
...
_s(ClientHeader, "/ZijgH6O6IbWklA9igOgVNswYlI=", false, function() {
    return [
...
//# sourceMappingURL=_401ac435._.js.map