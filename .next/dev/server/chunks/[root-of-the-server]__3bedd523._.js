...
"[project]/app/api/admin/establishment/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const market = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].market.findFirst();
        if (!market) {
        ...
        const employees = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].employee.findMany({
            where: {
                marketId: market.id
            }
        });
...
async function POST(req) {
    try {
        ...
        let market = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].market.findFirst();
        if (market) {
            // Update existing market
            market = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].market.update({
                where: {
                    id: market.id
                },
                data: {
            ...
            // Create new market
            market = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].market.create({
                data: {
                    name,
                    address: `${street}, ${number}, ${neighborhood}, ${city} - ${state}, ${cepDigits}`,
                    phone,
                    logo: "/market-logo.svg",
                    banner: "/market-banner.svg",
        ...
        if (Array.isArray(employees)) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].employee.deleteMany({
                where: {
                    marketId: market.id
                }
            });
            ...
            for (const emp of employees){
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].employee.create({
                    data: {
                        name: emp.name,
                        role: emp.role,
                        phone: emp.phone,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3bedd523._.js.map