...
async function GET(req) {
    try {
        ...
        const authUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                id: decoded.sub
            }
        });
        ...
        // Fetch clients
        const clients = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findMany({
            where: {
                role: "CLIENT"
            },
            include: {
        ...
        const orderCounts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.groupBy({
            by: [
                "userId"
            ],
            _count: {
        ...
        const orderCountMap = new Map(orderCounts.map((o)=>[
                o.userId,
                o._count._all
            ]));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__26eaa71a._.js.map