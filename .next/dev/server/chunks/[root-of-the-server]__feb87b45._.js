...
async function POST(req) {
    try {
        ...
        const clientId = ("TURBOPACK compile-time value", "217264700916-p0eikdjhg2ttc2fl9k0ri67fb7luvv6s.apps.googleusercontent.com") || process.env.GOOGLE_CLIENT_ID || "";
        ...
        if (!payload || !payload.email || payload.aud !== clientId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "invalid_token"
            }, {
                status: 401
        ...
        const phone = "";
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.upsert({
            where: {
                email
            },
            update: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__feb87b45._.js.map