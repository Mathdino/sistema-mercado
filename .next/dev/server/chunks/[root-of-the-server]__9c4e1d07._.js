...
"[project]/app/api/admin/financial/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const revenueAgg = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.aggregate({
            _sum: {
                totalAmount: true,
                deliveryFee: true
            },
        ...
        const productsAgg = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].orderItem.aggregate({
            _sum: {
                quantity: true
            },
            where: {
        ...
        const paymentGroups = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.groupBy({
            by: [
                "paymentMethod"
            ],
            _sum: {
        ...
        for (const pg of paymentGroups){
            paymentBreakdown[pg.paymentMethod.toLowerCase()] = pg._sum.totalAmount || 0;
        }
        // Recent orders
        const totalRecentOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.count({
            where: {
                status: {
                    not: "CANCELLED"
                },
        ...
        const recentOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.findMany({
            where: {
                status: {
                    not: "CANCELLED"
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c4e1d07._.js.map