...
"[project]/app/api/admin/fees/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const fees = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deliveryFee.findMany({
            orderBy: {
                createdAt: 'desc'
            }
        });
...
async function POST(req) {
    try {
        ...
        const fee = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deliveryFee.create({
            data: {
                type: type,
        ...
        if (fee.isActive) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deliveryFee.updateMany({
                where: {
                    id: {
                        not: fee.id
                    },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d170a11._.js.map