...
function AdminOrdersPage() {
    ...
    const sendWhatsAppMessage = (order, estimatedTime)=>{
        ...
        const orderItems = order.items.map((item)=>`• ${item.quantity}x ${item.productName} - ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$currency$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatCurrency"])(item.price)}`).join('\n');
...
//# sourceMappingURL=_018714d0._.js.map