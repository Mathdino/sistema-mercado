...
"[project]/app/api/delivery-fee/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const fee = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deliveryFee.findFirst({
            where: {
                isActive: true
            },
            orderBy: {
        ...
        const marketQuery = marketCep ? [
            ...
            marketCity?.trim(),
            marketState?.trim()
        ].filter(Boolean).join(", ") : market.address;
        ...
        const distanceKm = haversine(marketCoords.lat, marketCoords.lon, clientCoords.lat, clientCoords.lon);
        const perKm = Number(fee.perKmValue || 0);
        const minVal = Number(fee.minValue || 0);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aaf1a99c._.js.map